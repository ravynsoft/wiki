...
Developing for ravynOS requires a running ravynOS system to build on. Please make sure your hardware meets the [Hardware Requirements](/system-requirements).
